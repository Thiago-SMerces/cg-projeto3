  ...
  std::cerr << "Error" << std::endl;
              ...
              if (compareFloat(possible_moves[1].x_pos, move.x_pos) && compareFloat(possible_moves[1].y_pos, move.y_pos)) {
                ...
                for (auto index : iter::range(player2_pieces.size())) {
                  if (compareFloat(move.x_pos, player2_pieces[index].x_pos) && compareFloat(move.y_pos, player2_pieces[index].y_pos)) {
                ...
                if (player1_pieces[selected_piece].type == 'k' && player1_pieces[selected_piece].castling_index != -1) {
                  ...
                  if (rook_index > selected_piece) {
                    player1_pieces[rook_index].x_pos = player1_pieces[selected_piece].x_pos - 0.165f;
                  }
                  else {
                    player1_pieces[rook_index].x_pos = player1_pieces[selected_piece].x_pos + 0.165f;
                  }
            ...
            for (auto& piece : player2_pieces) {
              ...
              if (compareFloat(possible_moves[1].x_pos, move.x_pos) && compareFloat(possible_moves[1].y_pos, move.y_pos)) {
                ...
                for (auto index : iter::range(player1_pieces.size())) {
                  if (compareFloat(move.x_pos, player1_pieces[index].x_pos) && compareFloat(move.y_pos, player1_pieces[index].y_pos)) {
                ...
                if (player2_pieces[selected_piece].type == 'k' && player2_pieces[selected_piece].castling_index != -1) {
                  ...
                  if (rook_index < selected_piece) {
                    player2_pieces[rook_index].x_pos = player2_pieces[selected_piece].x_pos + 0.165f;
                  }
                  else {
                    player2_pieces[rook_index].x_pos = player2_pieces[selected_piece].x_pos - 0.165f;
                  }
